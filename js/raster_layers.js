...
const rasterLayerGroup = new ol.layer.Group({ layers: [ streamsLayer, NOAAWMSLayer ] });

const rasterLayerElements = document.querySelector('select[name=additional_layers]');
const selectedLayers = new Set();
const selectRasterLayer = rasterLayerElements.addEventListener('click', function(e) {
